    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/orders" className="mt-4 inline-block text-green-600 hover:text-green-700 font-medium">
            Go back to Orders
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Submit an Enquiry</h1>
              <p className="text-gray-600 mt-2">
                Have questions about your order? Let us know and we'll respond as soon as possible.
              </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Your Enquiry</h2>
          <form onSubmit={handleSubmit((data) => mutate(data))} className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-gray-500">Minimum 20 characters required</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link
                to="/orders"
                className="flex-1 sm:flex-none px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium text-center"
              >
                Cancel
              </Link>
            </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            ...
            For urgent matters, please contact us directly at support@botanicalcart.com
          </p>
        </div>
      </div>
    </div>
