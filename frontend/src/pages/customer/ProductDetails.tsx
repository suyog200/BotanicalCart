              ...
              >
                {quantity === 0 ? (
                  ...
                  <div className="flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-white rounded select-none text-black border border-black-300">
                    <button
                      ...
                      className="cursor-pointer text-md px-2 h-full hover:bg-gray-100 transition-colors"
                    >
                      -
                    </button>
                ...
                <div>
                  <button
                    ...
                    } text-white font-medium text-sm px-6 py-2 rounded-md active:scale-95 transition-all duration-200`}
