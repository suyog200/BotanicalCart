  ...
  return (
    <div className="mt-10">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-4 py-12">
        <div className="relative shadow-2xl shadow-indigo-600/40 rounded-2xl overflow-hidden shrink-0 w-full max-w-md h-96">
          <img
        ...
        <div className="text-xl text-slate-600 max-w-lg">
          ...
          <Link
            to="/products"
            className="inline-flex items-center gap-2 mt-8 hover:-translate-y-0.5 transition bg-gradient-to-r from-green-600 to-lime-500 py-3 px-8 rounded-full text-white"
          >
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value) => (
            <Card
              key={value.title}
              className="border-none text-center hover:shadow-plant transition-all duration-300 bg-white"
            >
